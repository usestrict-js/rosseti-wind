...
const Exam = () => (
  <Card interactive={true} elevation={Elevation.TWO}>
    ...
    <RadioGroup label="2. Какие сетевые настройки IED влияют на передачу GOOSE-сообщений?">
    ...
    <RadioGroup label="3. К какому механизму передачи данных относятся GOOSE-сообщения?">
    ...
    <RadioGroup label="4. Какие первоначальные четыре октета MAC-адреса зарезервировано за ТК57 МЭК?">
    ...
    <RadioGroup label="5. В каком диапазоне можно задавать VLAN для устройств, обменивающихся GOOSE сообщении?">
    ...
    <RadioGroup label="6. В какой главе серии стандартов МЭК 61850 описывается механизм передачи GOOSE сообщений?">
    ...
    <RadioGroup label="7. Можно ли задавать одинаковые MAC-адреса разным IED?">
      <Radio label="Да" value="one" />
      <Radio label="Нет" value="two" />
    </RadioGroup>

    <RadioGroup label="8. Как расшифровывается аббревиатура GOOSE?">
      <Radio
        label="Общее объектно-ориентированное событие на подстанции"
        value="one"
      />
      <Radio label="Быстрое сообщение релейной защиты" value="two" />
      <Radio
        label="Никак не расшифровывается, это название птицы"
        value="three"
      />
      <Radio
        label="Сообщение для передачи объема данных в энергетике"
        value="four"
      />
    </RadioGroup>

    <RadioGroup label="9. К какому методу передачи трафика относится GOOSE-сообщения?">
      <Radio label="Unicast" value="one" />
      <Radio label="Broadcast" value="two" />
      <Radio label="Multicast" value="three" />
    </RadioGroup>

    <RadioGroup label="10. По какому интерфейсу передаются GOOSE – сообщения?">
    ...
    <RadioGroup label="11. Какое минимальное время между дублирующими GOOSE-сообщениями типа 1А может быть установлено согласно «Корпоративному профилю МЭК 61850»?">
    ...
    <RadioGroup label="12. На каком уровне модели OSI передаются GOOSE – сообщения?">
    ...
    <RadioGroup label="13. Как обозначается устройство на цифровой подстанции передающее/принимающее информации и имеющее хотя бы один процессор?">
    ...
    <RadioGroup label="14. На каком уровне передается информация посредством GOOSE – сообщений?">
    ...
    <RadioGroup label="15. По какому механизму передачи данных работают GOOSE-сообщения?">
